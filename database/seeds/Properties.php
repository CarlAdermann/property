...
{
    const SEED_DATA = "1,Parramatta,NSW,Australia
...
100,Subiaco,WA,Australia";
    ...
    public function run()
    {
        ...
        foreach($this->getProperties() as $propertyData) {

            $property = explode(',', $propertyData);
    ...
    {
        return explode(PHP_EOL, self::SEED_DATA);
    }
}
